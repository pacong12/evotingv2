...
<div class="container">
    <div class="row mb-5">
        <div class="col-md-6 pt-md-5 mb-3 text-center text-md-start">
            <h1 class="text-uppercase">Selamat Datang Di E-Voting</h1>
            <h4>Mari Kita Sukseskan Pemilihan Ketua Osis <br> STAIS SUFYAN TSAURI MAJENANG</h4>
                ...
                <div class="col-md-3">
                    <div class="card">
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            <button class="btn btn-primary btn-block" data-bs-toggle="modal" data-bs-target="#default" data-visi="{{ $kandidat->visi }}" data-misi="{{ $kandidat->misi }}">Lihat Visi & Misi</button>
                        </div>
                    </div>
                </div>
                @endforeach
