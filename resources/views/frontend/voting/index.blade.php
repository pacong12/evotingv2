                        ...
                        <div class="col-md-3">
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    <button class="btn btn-secondary btn-block mb-3" data-bs-toggle="modal" data-bs-target="#default" data-visi="{{ $kandidat->visi }}" data-misi="{{ $kandidat->misi }}">Lihat Visi & Misi</button>
